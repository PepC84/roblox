...
local function shootBullet() 
	if not debounce then 
		...
		local vectorForceAttachment = serverStorage.mostBasicBullet.Attachment0:clone()
		vectorForceAttachment.Parent = newBullet
		
		local newForce = serverStorage.mostBasicBullet.VectorForce:clone()
		newForce.Parent = newBullet
		newForce.ApplyAtCenterOfMass = true
		newForce.Attachment0 = vectorForceAttachment
		newForce.Force = directionVector * speed
