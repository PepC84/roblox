...
fairiesToClone = ReplicatedStorage.Assets.enemyAssets.fifthBlueFairies --fairies to clone from replicated storage to workplace so clients can see it
...
subfolder = whereToClone.fifthBlueFairies
