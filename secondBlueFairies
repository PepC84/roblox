...
ReplicatedStorage.Assets.enemyAssets.secondBlueFairies:Clone().Parent = workspace.enemies.miniEnemies.blueFairies

for k,v in pairs(workspace.enemies.miniEnemies.blueFairies.secondBlueFairies:GetChildren()) do
	v:SetAttribute('id', k)
...
function main() 
	for _,v in pairs(workspace.enemies.miniEnemies.blueFairies.secondBlueFairies:GetChildren()) do
