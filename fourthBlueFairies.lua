...
yLimit = 231.5
fairyVectorsTable = require(ReplicatedStorage.paths.firstStage.blueFairy.downtomidleft)
fairiesToClone = ReplicatedStorage.Assets.enemyAssets.fourthBlueFairies --fairies to clone from replicated storage to workplace so clients can see it
...
subfolder = whereToClone.fourthBlueFairies
