...
fairiesToClone = ReplicatedStorage.Assets.enemyAssets.thirdBlueFairies --fairies to clone from replicated storage to workplace so clients can see it
...
subfolder = whereToClone.thirdBlueFairies
